...
var shadedDodecahedron = function() {
    ...
    var shape = "dodecahedron"; // Variabel untuk bentuk aktif
    ...
    function quad(a, b, c, d, vertices) {
        ...
        normalsArray.push(vertices[a], vertices[b], vertices[c]);
        normalsArray.push(vertices[a], vertices[c], vertices[d]);
    }
    ...
    function createDodecahedron() {
        positionsArray = [];
        normalsArray = [];
        quad5(0, 14, 9, 8, 13, dodecahedronVertices);
        quad5(1, 12, 17, 19, 5, dodecahedronVertices);
        quad5(2, 13, 8, 16, 18, dodecahedronVertices);
        quad5(3, 19, 17, 9, 14, dodecahedronVertices);
        quad5(4, 18, 16, 12, 1, dodecahedronVertices);
        quad5(5, 19, 3, 7, 11, dodecahedronVertices);
        quad5(6, 10, 11, 7, 15, dodecahedronVertices);
        quad5(7, 3, 14, 0, 15, dodecahedronVertices);
        quad5(8, 9, 17, 12, 16, dodecahedronVertices);
        quad5(0, 13, 2, 6, 15, dodecahedronVertices);
        quad5(4, 1, 5, 11, 10, dodecahedronVertices);
        quad5(4, 10, 6, 2, 18, dodecahedronVertices);
    }
    ...
    function createCube() {
        ...
        // Setiap quad mengambil 4 vertex untuk membuat 2 segitiga
    
        // Depan
        quad(0, 1, 2, 3, cubeVertices);
    
        // Belakang
        quad(4, 5, 6, 7, cubeVertices);
    
        // Kiri
        quad(0, 1, 5, 4, cubeVertices);
    
        // Kanan
        quad(3, 2, 6, 7, cubeVertices);
    
        // Atas
        quad(1, 2, 6, 5, cubeVertices);
    
        // Bawah
        quad(0, 3, 7, 4, cubeVertices);
    }
    ...
    function init() {
        ...
        switchShape(shape);  // Inisialisasi bentuk awal
        ...
        document.getElementById("ButtonDodecahedron").onclick = function () {
            switchShape("dodecahedron");
        };
        document.getElementById("ButtonCube").onclick = function () {
            switchShape("cube");
        };
